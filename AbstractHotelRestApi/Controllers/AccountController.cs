...
using AbstractHotelRestApi.Results;
...
namespace AbstractHotelRestApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public AccountController(IAdministratorService service)
        {
        ...
        public async Task<IHttpActionResult> ChangePassword(ChangePasswordBindingModel model)
        {
            ...
            IdentityResult result = await UserManager.ChangePasswordAsync(User.Identity.GetUserId<AppId>(), model.OldPassword,
                model.NewPassword);
        ...
        public async Task<IHttpActionResult> SetPassword(SetPasswordBindingModel model)
        {
            ...
            IdentityResult result = await UserManager.AddPasswordAsync(User.Identity.GetUserId<AppId>(), model.NewPassword);
        ...
        [AllowAnonymous]
        [Route("Register")]
        public async Task<IHttpActionResult> Register(AdministratorCreateBindingModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
